...
<Project ToolsVersion="Current" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
   ...
   <Target Name="CopyToTestProfile" DependsOnTargets="NetcodePatch" AfterTargets="PostBuildEvent">
      ...
      <!-- We will copy the asset bundle named "pinkgiantassets" over -->
      <Copy SourceFiles="../UnityProject/AssetBundles/StandaloneWindows/pinkgiantassets" DestinationFolder="$(TestDir)$(AssemblyName)-DEV/"/>
      <Exec Command="echo '[csproj.user] Mod files copied to $(TestDir)$(AssemblyName)-DEV/'" />
   </Target>
</Project>"""

fp = open(f'{thisPath}/Plugin/PinkGiant.csproj.user', 'w')
fp.write(userFile)
fp.close()
print(color.green + f'csproj.user file created at {thisPath}/Plugin/PinkGiant.csproj.user!')
