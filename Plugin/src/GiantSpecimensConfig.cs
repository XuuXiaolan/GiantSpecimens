...
namespace GiantSpecimens {
    public class GiantSpecimensConfig
    {
        ...
        public GiantSpecimensConfig(ConfigFile configFile) 
        {
            ...
            configSpeedRedWood = configFile.Bind("Misc Options",   // The section under which the option is shown
                                                "RedWood Giant Speed",  // The key of the configuration option in the configuration file
                                                2f, // The default value
                                                "Default walking speed of the RedWood Giant, (Chase speed is 4*Walking Speed) I recommend 1.5 to 2"); // Description of the option to show in the config file
