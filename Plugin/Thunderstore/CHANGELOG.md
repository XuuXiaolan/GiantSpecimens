...
- Forgot to apply my sliding bug fix from last changelog lol.

## v 2.2.0

- Probably fixed sliding bug.
- Recompiled for v62, should work now, enjoy.
...
- Almost done working on Stellar Sovereign and CactusWoodGiant, just gonna start transferring stuff over to [CodeRebirth](https://thunderstore.io/c/lethal-company/p/XuXiaolan/CodeRebirth/) and upload there instead of this mod from now on.
